...
describe("Test Contact Us for shopping website", () => {
    it.only("Should be able to navigate to contact page", () => {
        cy.visit('https://automationteststore.com/');
        
        //withnoxpath

        cy.get('.info_links_footer > :nth-child(5) > a').click().then(function(textname){
            console.log("the text is:"+textname.text())
        })
